 ...
 * @author COMPUTER
 */
public class BarangMasukDetail implements Serializable{
    ...
    public int hashCode() {
        int hash = 7;
        hash = 97 * hash + Objects.hashCode(this.lokasi);
        hash = 97 * hash + Objects.hashCode(this.masterBarang);
        ...
        hash = 97 * hash + Objects.hashCode(this.kategori_nf);
        hash = 97 * hash + Objects.hashCode(this.lok);
        hash = 97 * hash + this.qty;
        hash = 97 * hash + Objects.hashCode(this.isi);
        hash = 97 * hash + Objects.hashCode(this.total_qty);
    ...
    public boolean equals(Object obj) {
        ...
        final BarangMasukDetail other = (BarangMasukDetail) obj;
    ...
    public String toString() {
        return "BarangMasukDetail{" + "lokasi=" + lokasi + ", masterBarang=" + masterBarang + ", kode_transaksi=" + kode_transaksi + ", kode_barang=" + kode_barang + ", nama_barang=" + nama_barang + ", batch=" + batch + ", kategori_nf=" + kategori_nf + ", lok=" + lok + ", qty=" + qty + ", isi=" + isi + ", total_qty=" + total_qty + ", satuan=" + satuan + ", kemasan=" + kemasan + '}';
    }
